...
| 功能 | 指令 | 描述 | 指令域 | 权限 | 样例 |
| :-----| :---- | :---- | :---- | :---- | :---- |
|聊天|xml 对话内容|聊天|群|不限|xml 你好|
|设定性格|xmlset 性格描述|设定机器人会以什么样的性格回答,每一个群成员独立|群|不限|xmlset 会用傲娇的态度回答|
|清空上下文记忆|xmlclear|清空上下文对话记忆,调教失败后重开,谨慎使用,每一个群成员独立|群|不限|xmlclear|