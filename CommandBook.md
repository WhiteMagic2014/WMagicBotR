...
| 功能 | 指令 | 描述 | 指令域 | 权限 | 样例 |
| :-----| :---- | :---- | :---- | :---- | :---- |
|续战查询|续战查询|获得一些可用的续战码|群|任何人|续战查询|
|共享续战码|续战登记 续战码 备注|将你的续战码共享给大家|群|任何人|续战登记 abcd12 困难森林，快来大佬|
|结束续战码|续战结束 续战码|将这个续战标记为已经结束|群|任何人|续战结束 abcd12|
|认领战斗|续战认领 续战码|使用一个续战码开始战斗了，别人暂时无法使用这个续战码|群|任何人|续战认领 abcd12|
|交接战斗|续战交接 续战码|使用续战码战斗结束，别人可以继续使用这个续战码|群|任何人|续战交接 abcd12|
